...
namespace RuntimeTypeCreator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            stInfo.Fields.AddRange([new FieldDefinition("Version", "string"), new FieldDefinition("StatusCode", "int")]);
            ...
            stMachine.Fields.AddRange([new FieldDefinition("Buttons", "ST_Button[]"), new FieldDefinition("Info", "ST_Info")]);
